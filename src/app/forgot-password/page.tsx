...
export default function ForgotPassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setRetrievedPassword("demo@12345");
      setIsSubmitted(true);
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50/30 py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="mb-4 inline-flex items-center gap-1.5 rounded-full bg-success/30 px-3 py-1.5 text-xs font-medium text-green-900">
          ...
          <h1 className="mb-3 text-2xl font-bold leading-tight text-primary sm:text-3xl">
        ...
        <motion.div
          ...
          className="rounded-2xl bg-white/60 backdrop-blur-sm p-6 sm:p-8 shadow-sm ring-1 ring-black/5"
        >
          {!isSubmitted ? (
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-4 py-3 rounded-xl bg-white/80 backdrop-blur-sm border border-gray-200 focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200 placeholder:text-gray-400 text-sm sm:text-base"
                  />
                </div>
              ...
              <motion.button
                ...
                className="w-full flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-gradient-to-br from-primary to-primary/80 text-white font-semibold shadow-sm hover:shadow-md transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
              >
                {isLoading ? (
                  <>
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <div className="relative">
                  <input
                    ...
                    readOnly
                    className="w-full pl-4 pr-24 py-3 rounded-xl bg-gray-50 border border-gray-200 font-mono text-sm focus:outline-none focus:ring-2 focus:ring-primary/20"
                  />
              ...
              <div className="flex gap-3 pt-4">
                <button
                  onClick={handleReset}
                  className="flex-1 py-3 px-4 rounded-xl bg-gray-100 text-gray-700 font-medium hover:bg-gray-200 transition-colors text-sm"
                >
                  Search Another Email
                </button>
                <Link
                  href="/login"
                  className="flex-1 py-3 px-4 rounded-xl bg-primary text-white font-medium hover:bg-primary/90 transition-colors text-sm text-center"
                >
                  Go to Login
                </Link>
              </div>
